...
const showProductDetailsInModal = (product, _product_details) => {
  setInnerText("exampleModalLabel", product.title);
  setInnerText("productId", product.id);
  setInnerText("modal_body", product.description);
...
const updateTaxAndCharge = () => {
  ...
  if (priceConverted > 500) {
    ...
    setInnerText("total-tax", (priceConverted * 0.15).toFixed(2));
...
const a = document.getElementById("buy-now").addEventListener("click", () => {
